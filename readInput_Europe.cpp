...
//   string dataInputDir2 = "C:/MGusti/CurrentWork/GFM/georgPrgs/dima/DeforAforCCurves_growth/ManagementPlus/";      
  ...
  string dataInputDir2 = settings.inputPath + "\\";
	 //string FileName = dataInputDir + "oecd_ssp1_cramer_europe_jrc.txt";
	// string FileName = dataInputDir + "b2_cramer_europe_mai_euclimit_ref_12062013_lc_bas.txt";
  string FileName = "b2_cramer_europe_mai_euclimit_ref_12062013_lc_bas.txt";

	//string FileName = "./data/b2_cramer_europe_mai_euclimit_ref_12062013_lc_bas.txt";
...
//        if (header[ElemNum].first <= eyear)
         {
          ...
          else if (!strcmp(header[ElemNum].second.c_str(),"FORESTTYPE"))
            d.FORESTTYPE.insert(header[ElemNum].first,val);
...
//  FileName = dataInputDir2+"landPrice_ref_bas_ydfr_131210.txt";  
 // FileName = dataInputDir2+"landPrice_base_201210.txt";  
  //FileName = "./data/landPrice_base_201210.txt";
 // FileName = dataInputDir2+"landPrice_ref_201210.txt";  
  FileName = "landPrice_base_201210.txt";
...
//  FileName = dataInputDir2+"woodPrice_ref_bas_ydfr_131210.txt"; 
  ...
  //FileName = "./data/woodPrice_base_201210.txt";
//  FileName = dataInputDir2+"woodPrice_ref_201210.txt"; 
  FileName = "woodPrice_base_201210.txt";
...
//FileName = dataInputDir2+"woodProductionCountries_UA_wood.txt";
//FileName = dataInputDir2+"woodProductionCountries_UA_base.txt";
 // FileName = dataInputDir2+"woodProductionCountries_UA_agri.txt";
//  FileName = dataInputDir2+"woodProductionCountries_bas_nc_eu28_03052013_UA.txt";
  FileName = "woodProductionCountries_bas_nc_eu28_03052013_UA.txt";
 // FileName = "./data/woodProductionCountries_bas_nc_eu28_03052013_UA.txt";
//  FileName = dataInputDir2+"woodProductionCountries_ref_nc_eu27_28072011_const.txt"; //constant after 2005; 1990 and 1995 values are estimated by Hannes Bottcher; new wood production for EU27 countries: 27 July 2011;        
