...
//    countriesFmcpol.insert(	28	); // Belorussia
//    countriesFmcpol.insert(	39	);
//    countriesFmcpol.insert(	41	);
//    countriesFmcpol.insert(	56	); Cyprus
//    countriesFmcpol.insert(	57	);
...
//    countriesFmcpol.insert(	162	);
//    countriesFmcpol.insert(	165	);
    countriesFmcpol.insert(	174	);
    countriesFmcpol.insert(	177	);
...
//    countriesList.insert(	133	); //Monako
