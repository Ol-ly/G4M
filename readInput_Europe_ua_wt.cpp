...
//Opening a file  
  ...
  string dataInputDir2 = settings.inputPath + "\\";
	  ...
	  string FileName = "b2_cramer_europe_euclimit_bas_ua_ONLY.txt";
...
{
  ifstream fppr;
	FileName = "SawnWoodProduction_UA_EU.txt";
...
{
  ifstream fppr;
	FileName = "RestWoodProduction_UA_EU.txt";
